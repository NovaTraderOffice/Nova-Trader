          ...
          <div className="container mx-auto max-w-4xl">
            <div className="bg-[#1a1a1a] border border-yellow-600/30 rounded-xl p-6 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-4 relative">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-white mb-1">Gizliliğinize Önem Veriyoruz</h3>
                  <p className="text-sm text-gray-400">
                    Trading deneyimini geliştirmek ve trafiği analiz etmek için çerezler kullanıyoruz.
                  </p>
                </div>
              </div>
